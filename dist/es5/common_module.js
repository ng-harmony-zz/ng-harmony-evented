            ...
            for (var _iterator = this.iterate(this.constructor.prototype)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                if (key.match('::')) {
                    ...
                    (function () {
                        ...
                        el = _this.$element ? _this.$element.context : _zest2['default']('[ng-app]', document.body)[0];
                        _iteratorNormalCompletion2 = true;
                        _didIteratorError2 = false;
                        _iteratorError2 = undefined;

                        try {
                            for (_iterator2 = (tokens[0] ? _zest2['default'](tokens[0], el).entries() : [el].entries())[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
